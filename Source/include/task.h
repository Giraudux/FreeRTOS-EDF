 ...
 *
 */
#define xPeriodicTaskCreate( pvTaskCode, pcName, usStackDepth, pvParameters, uxCriticalDelay, uxPeriod, uxMaxExecutionTime, pxCreatedTask ) xPeriodicTaskGenericCreate( ( pvTaskCode ), ( pcName ), ( usStackDepth ), ( pvParameters ), ( uxCriticalDelay ), ( uxPeriod ), ( uxMaxExecutionTime ), ( pxCreatedTask ), ( NULL ), ( NULL ) )
...
void vTasksRestart( void ) PRIVILEGED_FUNCTION;
